...
pub fn draw(f: &mut Frame, area: Rect) {
    ...
    let rows = vec![
        ...
        Row::new(vec!["Search", "/search <txt>", "Search Messages"]),
        Row::new(vec!["", "n / N", "Next / Prev Match"]),
        Row::new(vec!["Chat", "/msg <user>", "Private Message"]),

        Row::new(vec!["Transfer", "/send <file>", "Send File"]),
        Row::new(vec!["", "/get <id>", "Download File"]),
        Row::new(vec!["Vault", "/vault_put <f>", "Store File"]),
        Row::new(vec!["", "/vault_get <f>", "Retrieve File"]),
        Row::new(vec!["", "/vault_list", "List Vault"]),
        Row::new(vec!["", "/browse", "Open File Browser"]),
        Row::new(vec!["Values", "/nuke", "WIPE EVERYTHING"]),
    ];
